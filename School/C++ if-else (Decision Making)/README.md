<h2><a href="https://practice.geeksforgeeks.org/problems/c-if-else-decision-making4138/1">C++ if-else (Decision Making)</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p>Given an integer N.&nbsp;Your task is to check if the integer is greater than, less than or equal to 5.<br>
